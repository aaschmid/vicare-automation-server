...
def test_init_settings_using_env_variables(change_test_dir) -> None:
...
def test_hash_return_same_for_same_config(change_test_dir) -> None:
    client_id = "environment variable"
    email = "test2@example.com"
    password = "654321"
...
def test_hash_return_different_for_different_config(change_test_dir) -> None:
    email = "test2@example.com"
    password = "654321"
    appletv_host = "192.168.1.20"
    appletv_companion_identifier = "AA:BB:CC:DD:EE:FF"
    appletv_companion_credentials = "creds789"
...
def test_hash_return_different_for_different_appletv_config(change_test_dir) -> None:
    client_id = "same_client"
    email = "same@example.com"
    password = "same_pass"
    appletv_host = "192.168.1.30"
